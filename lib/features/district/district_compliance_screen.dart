...
class DistrictComplianceScreen extends ConsumerWidget {
  const DistrictComplianceScreen({super.key});
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Expanded(flex: 1, child: _builddistrictLeagueTable()),
            ],
          ),
          const SizedBox(height: 32),
    ...
    return Row(
      ...
      children: [
        const Column(
          ...
          children: [
            Text(
              'District Dashboard: Compliance Analysis',
              style: TextStyle(
                fontSize: 28,
            ...
            SizedBox(height: 8),
            Text(
              'Strategic oversight and district benchmarking of tobacco control compliance',
              style: TextStyle(
                fontSize: 14,
  ...
  Widget _builddistrictLeagueTable() {
    return Container(
      padding: const EdgeInsets.all(24),
      decoration: BoxDecoration(
        color: Colors.white,

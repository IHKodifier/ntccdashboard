...
class ProvincialModuleScreen extends ConsumerWidget {
  const ProvincialModuleScreen({super.key});
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              '${dashboardState.selectedProvince} - $moduleName',
            ...
            Text(
              'Provincial-level $moduleName screen',
              style: const TextStyle(
                fontSize: 16,
            ...
            Container(
              ...
              child: const Column(
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                    'This provincial module screen is coming soon',
                    style: TextStyle(
                      fontSize: 14,
                      color: AppColors.textSecondary,
                    ),

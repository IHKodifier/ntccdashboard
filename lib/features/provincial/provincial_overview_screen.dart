...
class ProvincialOverviewScreen extends ConsumerWidget {
  const ProvincialOverviewScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final dashboardState = ref.watch(dashboardProvider);
    final provinceName = dashboardState.selectedProvince ?? 'Province';
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          _buildTitleSection(provinceName),
  ...
  Widget _buildTitleSection(String provinceName) {
    return Row(
      ...
      children: [
        Column(
          ...
          children: [
            Text(
              '$provinceName Dashboard Overview',
            ...
            Text(
              'Provincial monitoring of tobacco control efforts in $provinceName',
              style: const TextStyle(
                fontSize: 14,

...
class ProvincialReportsScreen extends ConsumerWidget {
  const ProvincialReportsScreen({super.key});
    ...
    return Row(
      ...
      children: [
        const Column(
          ...
          children: [
            Text(
              'Provincial Dashboard: Analytical Reports',
              style: TextStyle(
                fontSize: 28,
